      ...
      >
        {game.chars.map((c) => (
          <div
            key={c.name}
            /*
             * P2-1: Hover → scale(1.05) + boxShadow + brighter border
             */
            onMouseOver={(e) => {
              const el = e.currentTarget as HTMLDivElement;
              el.style.transform = "scale(1.05)";
              el.style.boxShadow = `0 6px 24px ${game.colorDim}`;
              el.style.borderColor = `${game.color}55`;
              el.style.background = "#111828";
            }}
            onMouseOut={(e) => {
              const el = e.currentTarget as HTMLDivElement;
              el.style.transform = "";
              el.style.boxShadow = "";
              el.style.borderColor = `${game.color}22`;
              el.style.background = "#0c1020";
            }}
            style={{
              background: "#0c1020",
